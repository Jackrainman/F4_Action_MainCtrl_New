...
pos_node_t pos_array[POS_NUM + EX_NODE_NUM] = {
    ...
    [1] = {4911.820f, -96.255f, 0.265f, POINT_TYPE_ACTION_FLAT},
    [2] = {5245.288f, 6467.802f, 0.0f, POINT_TYPE_ACTION_FLAT},
    [3] = {471.081f, 6509.423f, 0.020f, POINT_TYPE_ACTION_FLAT}, /*!< 点位信息 */
    [4] = {134.288f, 128.072f, 0.020f, POINT_TYPE_ACTION_FLAT},
